...
#-------- correlação entre peso corporal e tamanho do cérebro em animais
library(MASS)
head(Animals)
...
#correlação tamanho do motor x mpg
Motor_Consumo <- cor(Cars93$EngineSize, Cars93$MPG.city, method = "pearson")

#r² - O quanto a variação de uma variável é explicada pela outra
Motor_Consumo^2

#correlação motor x potência
cor(Cars93$EngineSize, Cars93$Horsepower, method = "pearson")
